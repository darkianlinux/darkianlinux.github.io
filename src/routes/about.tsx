  ...
  return (
    <section className="max-w-4xl mx-auto px-6 py-20">
      ...
      <p className="mt-6 text-lg text-muted-foreground">
        ...
        focused, and uncompromising workspace.
      </p>

      <div className="mt-12 grid md:grid-cols-3 gap-5">
        {[
          { icon: BookOpen, title: "Educational", text: "Designed for cybersecurity courses, CTFs and OSCP-style training." },
          { icon: ShieldAlert, title: "Ethical", text: "Use only on systems you own or are authorized to test. Period." },
          { icon: Users, title: "Community", text: "Open-source, no ads, no telemetry. Built by hackers, for hackers." },
        ].map((c, i) => (
